// This file is generated by kxml_compiler from eagle.xsd.
...
void Signal::setClassName( int v )
{
  mClassName = v;
}

int Signal::className() const
{
  return mClassName;
}
...
Signal Signal::parseElement( const QDomElement &element, bool *ok )
{
  ...
  result.setName( element.attribute( "name" ) );
  result.setClassName( element.attribute( "class" ).toInt() );
...
void Signal::writeElement( QXmlStreamWriter &xml ) const
{
  xml.writeStartElement( "signal" );
      ...
      xml.writeAttribute( "class", QString::number( className() ) );
...
void Element::setAttribute( const Attribute &v )
{
  mAttribute = v;
}

Attribute Element::attribute() const
{
  return mAttribute;
}

void Element::setVariant( const Variant &v )
{
  mVariant = v;
}

Variant Element::variant() const
{
  return mVariant;
}
...
void Element::writeElement( QXmlStreamWriter &xml ) const
{
  ...
  attribute().writeElement( xml );
  variant().writeElement( xml );
  xml.writeEndElement();
}
...
void Designrules::setDescription( const Description &v )
{
  mDescription = v;
}

Description Designrules::description() const
{
  return mDescription;
}

void Designrules::setParam( const Param &v )
{
  mParam = v;
}

Param Designrules::param() const
{
  return mParam;
}
...
Frame Frame::parseElement( const QDomElement &element, bool *ok )
{
  ...
  if (element.hasAttribute("border-left"))  {
    BorderLeftEnum border_left = borderLeftEnumFromString( element.attribute( "border_left" ), ok  );
    if (ok && *ok == false) {
  ...
  if (element.hasAttribute("border-top"))  {
    BorderTopEnum border_top = borderTopEnumFromString( element.attribute( "border_top" ), ok  );
    if (ok && *ok == false) {
  ...
  if (element.hasAttribute("border-right"))  {
    BorderRightEnum border_right = borderRightEnumFromString( element.attribute( "border_right" ), ok  );
    if (ok && *ok == false) {
  ...
  if (element.hasAttribute("border-bottom"))  {
    BorderBottomEnum border_bottom = borderBottomEnumFromString( element.attribute( "border_bottom" ), ok  );
    if (ok && *ok == false) {
...
void Clearance::setClassName( int v )
{
  mClassName = v;
}

int Clearance::className() const
{
  return mClassName;
}
...
void ClassName::setNumber( int v )
{
  mNumber = v;
}

int ClassName::number() const
{
  return mNumber;
}

void ClassName::setName( const QString &v )
{
  mName = v;
}
...
void ClassName::setWidth( double v )
{
  mWidth = v;
}

double ClassName::width() const
{
  return mWidth;
}

void ClassName::setDrill( double v )
{
  mDrill = v;
}

double ClassName::drill() const
{
  return mDrill;
}

void ClassName::addClearance( const Clearance &v )
{
  mClearanceList.append( v );
}

void ClassName::setClearanceList( const Clearance::List &v )
{
  mClearanceList = v;
}

Clearance::List ClassName::clearanceList() const
{
  return mClearanceList;
}

ClassName ClassName::parseElement( const QDomElement &element, bool *ok )
{
...
void ClassName::writeElement( QXmlStreamWriter &xml ) const
{
...
void Classes::addClassName( const ClassName &v )
{
  mClassNameList.append( v );
}

void Classes::setClassNameList( const ClassName::List &v )
{
  mClassNameList = v;
}

ClassName::List Classes::classNameList() const
{
...
Classes Classes::parseElement( const QDomElement &element, bool *ok )
{
  ...
  for( n = element.firstChild(); !n.isNull(); n = n.nextSibling() ) {
    ...
    if ( e.tagName() == "class" ) {
      bool ok;
      ClassName o = ClassName::parseElement( e, &ok );
      if ( ok ) result.addClassName( o );
    }
  }
...
void Classes::writeElement( QXmlStreamWriter &xml ) const
{
  if ( !classNameList().isEmpty() ) {
    ...
    foreach( ClassName e, classNameList() ) {
      e.writeElement( xml );
    }
    xml.writeEndElement();
  }
...
{
  if ( !pinrefList().isEmpty() || !portrefList().isEmpty() || !wireList().isEmpty() || !junctionList().isEmpty() || !labelList().isEmpty() ) {
...
void Net::setClassName( int v )
{
  mClassName = v;
}

int Net::className() const
{
  return mClassName;
}
...
void Part::setAttribute( const Attribute &v )
{
  mAttribute = v;
}

Attribute Part::attribute() const
{
  return mAttribute;
}

void Part::setVariant( const Variant &v )
{
  mVariant = v;
}

Variant Part::variant() const
{
  return mVariant;
}
