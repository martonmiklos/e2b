...
class Settings
{
  public:
    ...
    Setting::List settingList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Element
{
  ...
  public:
    ...
    void setRot( const QString &v );
    QString rot() const;
    void setAttribute( const Attribute &v );
...
class Elements
{
  public:
    ...
    Element::List elementList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Connects
{
  public:
    ...
    Connect::List connectList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Technologies
{
  public:
    ...
    Technology::List technologyList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Devicesets
{
  public:
    ...
    Deviceset::List devicesetList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Libraries
{
  public:
    ...
    Library::List libraryList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Variantdefs
{
  public:
    ...
    Variantdef::List variantdefList() const;
    /**
      Parse XML object from DOM element.
     */
...
class ClassName
{
  ...
  public:
    ...
    Clearance::List clearanceList() const;
    /**
      Parse XML object from DOM element.
     */
    static ClassName parseElement( const QDomElement &element, bool *ok );
    void writeElement( QXmlStreamWriter &xml ) const;
...
{
  public:
    void addClassName( const ClassName &v );
    void setClassNameList( const ClassName::List &v );
    ClassName::List classNameList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Errors
{
  public:
    ...
    Approved::List approvedList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Net
{
  ...
  public:
    ...
    Segment::List segmentList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Instances
{
  public:
    ...
    Instance::List instanceList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Moduleinsts
{
  public:
    ...
    Moduleinst::List moduleinstList() const;
    /**
      Parse XML object from DOM element.
     */
